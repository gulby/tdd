...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        self.assertEqual(error.text, u'빈 아이템을 등록할 수 없습니다')
        
        # 다른 아이템을 입력하고 이번에는 정상 처리된다.
        self.browser.find_element_by_id('id_new_item').send_keys(u'우유 사기\n')
        ...
        # 아이템을 입력하면 정상 동작한다.
        self.browser.find_element_by_id('id_new_item').send_keys(u'tea 만들기\n')
        self.check_for_row_in_list_table(u'1: 우유 사기')
